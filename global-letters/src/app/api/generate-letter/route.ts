...
- 불안/무기력 (괜찮은 척하느라 지친 마음): "아무렇지 않은 척 말하는 것이 익숙한 습관이 되었을지도 모르겠습니다. 누가 물어보아도 괜찮다고, 별일 아니라고 미소 지어 넘겼을 테지요. 하지만 당신의 깊은 내면은 아주 오래전부터 무겁게 지쳐 있었을 것입니다."`;
      ...
      if (run.status === 'completed') {
        ...
        if (lastMessage && lastMessage.content[0].type === 'text') {
          ...
          if (typeof parsedResponse.cover.title !== 'string') {
            parsedResponse.cover.title = isKo 
              ? ((productType === "free" || productType === "random") ? "너를 위한 안부 편지" : "마음을 위한 문장 처방전")
              : "Sentence Prescription for You";
          }
          if (typeof parsedResponse.cover.heart_name !== 'string') {
            parsedResponse.cover.heart_name = isKo 
              ? ((productType === "free" || productType === "random") ? "안부가 필요한 네 마음에게" : `${giftRecipient || "소중한 마음"}님에게`)
          ...
          // 🛡️ Apply ending tone validation filter before returning
          applyPostProcessFilters(parsedResponse, productType);
    ...
    if (productType === "free") {
      fallbackResponse.cover.title = isKo ? "너를 위한 안부 편지" : "Comforting Greeting for You";
      fallbackResponse.cover.heart_name = isKo ? "안부가 필요한 네 마음에게" : "To a Heart in Need of Greeting";
      fallbackResponse.page_letter_paragraphs = isKo ? [
        "많이 힘들었겠다. 괜찮다고 말하면서도 사실은 마음 한쪽에서 계속 무너지는 소리가 났을 것 같아. 사람들 앞에서는 웃고 아무렇지 않은 척 하루를 보내도 혼자가 되는 밤마다 네 마음은 오래 참아온 눈물을 가만히 삼켰겠지. 그런 너에게 더 힘을 내어 버티라고 말하고 싶지 않아. 너는 이미 오늘 하루도 충분히 많은 고단한 날들을 씩씩하게 버텨왔으니까. 오늘의 무거운 발걸음이 너를 자책하게 만들지 않았으면 좋겠어. 그 모든 아픔과 힘듦은 절대 네 잘못이 아니야.",
        "오늘은 너무 괜찮으려고 애쓰지 않았으면 좋겠어. 울고 싶다면 잠시 울어도 괜찮고, 아무것도 할 수 없는 무기력한 밤이라면 그저 숨만 고르는 차분한 하루여도 다 괜찮아. 봄이 오기 전의 메마른 나뭇가지들도 한동안은 멈춘 것처럼 보이지만, 그 안에서는 다시 꽃을 피워낼 소중한 시간들이 가만히 흐르고 있지. 네 마음도 그랬으면 좋겠어. 오늘의 너를 너무 미워하지 말고, 여기까지 오느라 참 많이 애썼다고 스스로에게 다정하게 말해주길 바랄게. 언제나 네 곁에서 가만히 응원하고 있어."
      ] : [
        "It must have been so hard for you. Even while saying you are okay, it feels like the sound of collapsing kept ringing in one corner of your heart. Even if you smiled in front of other people and spent the day pretending to be fine, every night when you were left alone, your heart must have gently swallowed the tears you held back for so long. I don't want to tell you to endure more. You have already survived enough difficult days. I hope today's heavy steps do not make you blame yourself, because all this pain and hardship is never your fault.",
        "I hope you don't try too hard to be okay today. It's totally okay to cry for a while if you want to, and if it's a night when you can't do anything, it's fine to just catch your breath. Branches before spring comes look as if they have completely stopped for a while, but inside them, the time to bloom again is still silently flowing. I hope your heart behaves like that. Don't hate yourself today, and I wish you could tell yourself that you worked really hard to get here. I will always support you gently with all my heart."
      ];
      ...
      fallbackResponse.page_sentences = isKo ? [
        "가장 당신다운 호흡으로, 오늘 하루를 가만히 채워나가시기를 바랍니다.",
      ...
      fallbackResponse.page_letter_paragraphs = isKo ? [
        ...
        "당신은 그 누구보다 귀하고 존재 자체만으로도 사랑받아 마땅한 사람임을 꼭 기억해 주시기를 바랍니다. 주변 사람들의 기대나 세상이 말하는 기준에 억지로 맞추려 하며 자신을 갉아먹지 마십시오. 타인의 시선이나 평가보다 백배는 더 중요한 것은 지금 이 순간 내 마음에 귀를 기울이는 일입니다. 지금 겪는 아픔은 당신이라는 존재의 전부가 아니며 인생이라는 긴 여정 속에서 잠시 지나가는 어둡고 긴 터널일 뿐이지요. 어둠 속에서는 아무리 빛을 찾으려 해도 보이지 않아 막막하겠지만 터널은 반드시 끝이 있습니다. 지금은 억지로 달리려 하지 말고 안전한 그늘에 가만히 앉아 숨을 고르며 아픈 상처를 돌보셔도 괜찮습니다.",
        "이제는 타인을 향해 보냈던 따뜻한 시선과 배려를 온전히 당신 자신에게로 돌려줄 차례입니다. 가장 힘들고 지쳤을 때 누군가에게 정말 듣고 싶었던 그 따뜻한 말들을 스스로에게 들려주십시오. ‘그동안 정말 고생 많으셨습니다, 이제는 조금 쉬어도 괜찮습니다’라며 당신의 편이 되어 나직하게 속삭여 줍니다. 마음속에 다정한 온기와 안도감이 채워질 때 우리를 억누르고 있던 무거운 사슬들도 자연스럽게 풀려갈 것입니다. 오늘의 무너짐은 실패가 아니라 나를 진정으로 아끼고 돌보는 새로운 시작을 알리는 신호입니다. 어떤 순간에도 스스로를 포기하지 마십시오. 언제나 당신의 곁에서 온 마음을 다해 응원하겠습니다.",
        "마지막으로 오늘 밤 당장 실천해볼 수 있는 아주 작은 행동을 제안해 드립니다. 잠자리에 들기 전 창문을 활짝 열고 밤공기를 가만히 마시는 것이지요. 그다음 가만히 가슴에 손을 얹고 나의 호흡을 느껴봅니다. 스스로에게 ‘오늘 참 애썼습니다’라고 따뜻하게 위로해 주어도 좋습니다. 지친 마음에 편안한 쉼을 선물해주시기 바랍니다. 스스로에게 다정해지는 연습을 이렇게 작은 일에서부터 시작해 보세요. 오늘 밤 당신에게 편안한 안식이 깃들기를 기원합니다."
      ] : [
      ...
      fallbackResponse.page_sentences = isKo ? [
        ...
        "어떤 순간에도 스스로를 포기하지 않는 당신의 편이 되어주시기를 기원합니다."
      ] : [
        "I hope you gently fill your day today with your own unique breath.",
        "You can rest and lean back anytime if it is hard. There is always unseen support next to you.",
        "Living as your true self sometimes begins when you finally break down.",
      ...
      fallbackResponse.page_questions = isKo ? [
        "요즘 당신이 괜찮은 척하느라 가장 오래 삼킨 말은 무엇일까요?",
        "그때의 당신에게 정말 해주고 싶었던 말은 무엇이었나요?",
        "앞으로 당신을 지키기 위해 거절해야 할 생각은 무엇일까요?"
      ] : [
        "What is the word I swallowed the longest while pretending to be okay lately?",
        "What was the word I really wanted to say to myself at that time?",
      ...
      fallbackResponse.page_action = isKo 
        ? "따뜻한 허브차 한 잔을 마시며 5분간 온전히 당신의 호흡에 집중해 봅니다."
        : "Drink a cup of warm tea and fully focus on your breathing for 5 minutes.";
    ...
    // 🛡️ Apply ending tone validation filter before returning
    applyPostProcessFilters(fallbackResponse, productType);
...
const getDefaultRecoveryDays = (isKo: boolean) => isKo ? [
  {
    day: 1,
    letter: "오늘부터 7일간의 아름다운 여정을 함께하게 되어 정말 기쁩니다. 첫날인 오늘은 무언가를 억지로 바꾸려 하지 않고, 그저 지금 당신의 마음에 가만히 이름을 붙여주는 연습을 해볼 것입니다. 우리는 보통 슬프거나 지치거나 화가 날 때, 마음 한구석에 숨겨둔 감정들을 그냥 '힘들다'는 투박한 한마디로 덮어버리곤 합니다. 그렇게 갈 길을 잃은 감정들은 마음 아주 깊은 곳에 쌓여서, 나중에 당신을 더 무겁게 짓누르고 아프게 만들지요. 오늘은 잠시 가만히 멈춰 서서 지금 당신이 느끼는 구체적인 감정의 결을 소리 내어 다정하게 불러보시기 바랍니다. '당신은 오늘 하루 종일 괜찮은 척 웃느라 참 많이 피곤했다'라든가, '마음 한쪽이 텅 빈 것처럼 쓸쓸하다'처럼 말이에요. 감정에 정확하고 구체적인 이름을 붙여주는 것만으로도, 그 감정은 스스로를 치유하고 흘러갈 준비를 마칩니다. 뇌과학에서도 감정에 이름을 붙이는 명명 작용을 통해 뇌의 감정 중추인 편도체의 과도한 불안과 흥분이 차분히 가라앉는다고 하지요. 오늘 밤 침대에 눕기 전, 굳어있던 당신의 마음에 가장 알맞은 따뜻하고 예쁜 이름을 선물해 주시기 바랍니다.",
    sentence: "오늘 마음에 붙여준 이름: '괜찮은 척하느라 참 지쳤던 마음'",
    action: "자기 전에 가슴에 가만히 손을 얹고, 오늘 당신의 감정을 한 문장으로 나직하게 소리 내어 말해보기"
  },
  {
    day: 2,
    letter: "어제 마음에 이름을 붙여주는 첫 연습을 하며 어떠한 감정을 느끼셨을지 가만히 생각하게 됩니다. 조금은 어색하고 낯설었을지라도 오롯이 스스로를 돌아보고 알아차려 준 그 시간 자체가 정말로 귀중한 시작입니다. 둘째 날인 오늘은 어제에 이어 '괜찮은 척했던 마음의 가면을 가만히 내려놓기'를 연습해 보겠습니다. 우리는 학교나 직장, 혹은 친구들을 만날 때 늘 아무렇지 않은 척, 늘 밝고 건강한 척 가면을 쓰곤 하지요. 하지만 그렇게 온종일 쓰고 있던 두껍고 무거운 가면을 집으로 돌아온 밤까지 벗지 못한다면 마음은 결국 짓눌려 숨이 막히고 맙니다. 오늘은 단 10분만이라도 그 무거운 가면을 내려놓고 마음의 여리고 약한 취약함을 솔직하게 대면해 보십시오. 꼭 누군가에게 보이기 위해서가 아니라 당신 스스로에게 다정해지기 위함입니다. 괜찮지 않아도 정말로 괜찮습니다. 울고 싶다면 마음껏 소리 내어 울어도 좋고, 답답하다면 감정을 밖으로 가만히 쏟아내 보시기 바랍니다. 감정을 가둘수록 상처는 안으로 곪아가지만, 밖으로 비워낼 때 비로소 회복이 시작될 테니까요.",
    sentence: "괜찮지 않아도 괜찮습니다. 오늘의 당신은 조금 아프고 약해져도 괜찮은 사람이니까요.",
    action: "하루 중 가장 괜찮은 척 애써야 했던 장면을 작은 종이에 한 줄로 솔직하게 적고 가만히 찢어버리기"
  },
  {
    day: 3,
    letter: "벌써 셋째 날이 되었는데 어제 가면을 조금이나마 내려놓고 지내보니 기분이 어떠셨을지 궁금합니다. 오늘은 마음속에 가장 날카롭고 깊이 박혀 당신을 찌르고 있는 가시인 '자책을 덜어내는 날'입니다. 삶에서 힘든 일이 생기거나 누군가와의 관계가 뜻대로 흘러가지 않을 때 우리는 무의식적으로 스스로에게 칼날을 겨누곤 합니다. ‘전부 제 탓입니다’라며 자책하는 습관은 당신의 소중한 가치를 갉아먹는 가장 아픈 독이 될 뿐이지요. 당신이 겪고 있는 모든 흔들림과 아픔은 결코 당신이 부족하거나 약해서가 아닙니다. 그 어떤 누구라도 그 힘겨운 상황 속에서는 당신처럼 힘들어했을 것이고, 당신은 그 와중에도 최선을 다하셨습니다. 그러니 오늘만큼은 스스로를 찌르던 날카로운 화살을 내려놓으시기 바랍니다. 자신을 탓하던 차가운 말들 대신에 '그때는 그럴 수밖에 없었습니다', '그동안 참 고생 많으셨습니다'라며 따뜻한 위로를 들려주십시오. 당신의 온전한 편이 되어줄 유일한 사람은 바로 당신 자신입니다.",
    sentence: "그것은 당신의 잘못이 아닙니다. 당신은 그 아픔 속에서도 매 순간 최선을 다했으니까요.",
    action: "거울 속 당신의 눈을 가만히 바라보며 '당신은 잘못이 없어요, 참 잘해왔어요'라고 따뜻하게 속삭여주기"
  },
  {
    day: 4,
    letter: "넷째 날이 왔으며 어느덧 마음을 보듬는 여정의 절반을 지나왔습니다. 오늘은 온종일 생각에만 갇혀 있던 감정의 무거운 굴레에서 잠시 벗어나, 몸의 감각을 깨워보는 연습을 함께해 봅니다. 마음이 무거울 때 방안에 가만히 누워 생각의 꼬리를 물다 보면, 우리의 뇌는 부정적인 시나리오를 끊임없이 만들어 냅니다. 그 생각의 고리를 즉시 끊어내는 가장 확실한 방법은 바로 몸의 감각을 부드럽게 깨우는 일이지요. 대단한 운동을 하거나 밖으로 거창하게 나가지 않아도 좋습니다. 그저 5분 동안 방 안의 창문을 열고 환기를 시키거나 차가운 물로 세수를 하며 피부에 닿는 촉감에 온전히 집중해 보십시오. 몸이 움직이기 시작하면 정체되어 있던 마음의 흐린 안개도 한결 맑게 개기 마련입니다. 무기력함이 당신을 지배하려 할 때, 가벼운 몸의 움직임 하나로 지친 몸과 마음에 활기찬 치유를 선물해 주시기 바랍니다.",
    sentence: "생각이 너무 무거워질 때는 잠시 멈추고, 지금 당신의 손끝과 발끝의 감각을 가만히 느껴보세요.",
    action: "창문을 활짝 열고 시원한 공기를 세 번 깊게 들이쉬며, 당신 몸의 호흡이 나가는 것을 가만히 관찰하기"
  },
  {
    day: 5,
    letter: "다섯째 날이 밝았으며 오늘의 당신은 마음의 깊은 곳에 가만히 가라앉혀 두었던 삼킨 말을 꺼내보는 시간을 가집니다. 누군가에게 상처를 주거나 관계가 깨질까 봐 두려워 억지로 삼켜버린 말들은 마음속에서 사라지지 않고 계속 당신을 아프게 하지요. 그 응어리진 말들은 밖으로 꺼내어 마주하기 전까지는 계속해서 내면에서 비명을 지릅니다. 오늘은 그 누구의 시선도 보지 말고 오직 당신만 볼 수 있는 일기장에 그동안 참았던 감정을 아주 솔직하게 적어 보십시오. '그때 전 정말 서운했습니다'라든가, '사실 저 요즘 너무 외롭습니다'처럼 날것 그대로 적어보는 것이지요. 그렇게 글로 적어 눈으로 확인하는 순간, 내면에 갇혀 가슴을 조이던 억압된 슬픔이 비로소 자유를 얻게 됩니다. 표현되지 못한 아픔은 절대 스스로 사라지지 않음을 명심하시기 바랍니다. 가장 안전한 당신만의 공간에서 그 소중한 목소리를 가만히 꺼내어 해방해 주시기 바랍니다.",
    sentence: "삼켜왔던 아픈 말들을 이제는 당신의 가슴 밖으로 가만히 내어주어도 괜찮습니다.",
    action: "누구에게도 하지 못했던 속마음 한 문장을 노트에 꾹꾹 눌러 적은 뒤, 다 적고 나서 후련하게 크게 한숨 쉬기"
  },
  {
    day: 6,
    letter: "여섯째 날이 왔으며 여정의 끝자락이 드디어 가까워지고 있습니다. 오늘은 고립되어 있던 당신만의 동굴을 나와 세상과 가볍게 닿아보는 날로 보내보십시오. 마음이 지칠 때 우리는 본능적으로 깊이 숨어버리게 되고, 그 외로운 단절 속에서 아픔은 증폭됩니다. 하지만 우리는 타인과의 작고 사소한 연결을 통해서도 엄청난 안도감과 지지를 얻을 수 있는 존재이지요. 결코 많은 에너지를 써서 사람들을 만나러 나가지 않아도 좋습니다. 평소 고마웠던 사람에게 '잘 지내고 있나요?' 하고 짧은 안부 문자를 보내거나 이웃에게 가벼운 눈인사를 건네보십시오. 타인과 가볍게 주고받는 안부의 한마디는 당신의 어두운 마음에 따뜻한 등불 하나를 켜줄 것입니다. 여전히 내가 이 세상과 연결되어 있다는 안도감이 오늘 당신의 발걸음을 한결 가볍게 만들어 주기를 바랍니다.",
    sentence: "당신은 결코 혼자가 아닙니다. 보이지 않아도 따뜻한 연결이 주변을 감싸고 있으니까요.",
    action: "가까운 지인이나 소중한 사람에게 '문득 생각나서 연락했어요, 좋은 하루 보내세요'라고 부담 없는 안부 문자 보내기"
  },
  {
    day: 7,
    letter: "드디어 7일간의 길고 아름다운 회복 여정을 마무리하는 마지막 날에 이르렀습니다. 일주일 동안 매일 잊지 않고 자신의 내면을 들여다보고 안부를 묻는 일은 결코 쉽지 않았을 텐데 참 자랑스럽습니다. 그동안 상처받은 마음을 스스로 보듬고 돌보느라 진심으로 고생 많으셨습니다. 오늘은 오직 당신 자신만을 위해 온기가 가득 담긴 감사와 위로의 답장을 가만히 선물해 보십시오. 거울 속 당신의 눈을 바라보며 '포기하지 않고 견디며 살아내 주어서 정말 고맙습니다'라고 전해보시기 바랍니다. 이 7일간의 발자국들이 마음속에 씨앗이 되어 당신 삶에 다정한 꽃을 피워낼 것이라 믿습니다. 언제나 당신을 향해 있을 저의 따뜻한 응원을 잊지 마시고 늘 평안하시기를 간절히 기도합니다.",
    sentence: "7일 동안 멈추지 않고 스스로를 돌봐준 당신에게, 온 마음을 다해 고맙다는 인사를 건넵니다.",
    action: "이 여정을 끝마친 당신 자신을 위해 따뜻하고 포근한 차 한 잔을 선물하며, 가만히 눈을 감고 수고한 내 어깨를 토닥여주기",
    summary_sentences: [
      "아픔은 머무는 것이 아니라, 잠시 스쳐 지나가는 소나기일 뿐입니다.",
      "흔들릴 때는 마음껏 흔들려도 괜찮습니다, 결국 제자리로 돌아오면 되니까요.",
      "어떤 순간에도 당신 자신의 편에 서서 가만히 지지해 주시기를 바랍니다."
    ]
  }
] : [
  {
...
function applyPostProcessFilters(responseObj: any, productType: string) {
  if (!responseObj) return;
  
  const toneType = (productType === "free" || productType === "random") ? "informal" : "formal";
  
  if (Array.isArray(responseObj.page_letter_paragraphs)) {
    responseObj.page_letter_paragraphs = responseObj.page_letter_paragraphs.map((para: string) => 
      postProcessEndingTone(para, toneType)
    );
  }
  
  if (Array.isArray(responseObj.recovery_days)) {
    responseObj.recovery_days.forEach((dayData: any) => {
      if (dayData && typeof dayData.letter === 'string') {
        dayData.letter = postProcessEndingTone(dayData.letter, "formal");
      }
    });
  }
}
