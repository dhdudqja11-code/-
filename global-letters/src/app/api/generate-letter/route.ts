...
1. Tone and Manner Separation:
   - For FREE and RANDOM tiers ('free', 'random'): You MUST use warm, comforting, and poetic informal Korean (반말체). Use endings like "~했겠다", "~하길 바라", "~했으면 좋겠어", "~란다", "~렴", "~아", "~지". For the target addressee (pronouns), strictly use "너" or "네" or "네 마음". NEVER use formal terms like "당신", "귀하", or polite endings like "~요", "~습니다", "~합니다", "~바랍니다".
   - For PAID tiers ('beta', 'deep', 'recovery', 'gift'): You MUST use warm, comforting, and polite honorific Korean (존댓말체). Use endings like "~요", "~습니다", "~합니다", "~지요", "~바랍니다". For the target addressee (pronouns), strictly use "당신", "당신의", "당신의 마음" or the recipient's name with "님" (e.g., "${giftRecipient || "소중한 분"}님"). NEVER use informal pronouns like "너", "네" or informal endings like "~구나", "~렴", "~되렴", "~했으면 해", "~란다", "~단다".
2. Strict Ending Repetition Prevention Rule (CRITICAL):
   ...
   - For FREE/RANDOM: Alternate between different informal ending types (e.g. sentence 1: "~했겠다" / sentence 2: "~하길 바라" / sentence 3: "~했으면 좋겠어" / sentence 4: "~란다" / sentence 5: "~지"). Do not repeat the same ending class.
   - For PAID (BETA/DEEP/RECOVERY/GIFT): Alternate between Hapsyo-style ("~습니다", "~합니다", "~바랍니다") and Haeyo-style ("~요", "~지요", "~죠", "~군요"). (e.g. sentence 1: "~습니다" / sentence 2: "~요" / sentence 3: "~지요" / sentence 4: "~합니다" / sentence 5: "~죠").
...
- 불안/무기력 (괜찮은 척하느라 지친 마음): "아무렇지 않은 척 말하는 것이 익숙한 습관이 되었을지도 모르겠습니다. 누가 물어보아도 괜찮다고, 별일 아니라고 미소 지어 넘겼을 테지요. 하지만 당신의 깊은 내면은 아주 오래전부터 무겁게 지쳐 있었을 것입니다."`;
    ...
    if (productType === "free") {
      ...
      fallbackResponse.page_letter_paragraphs = isKo ? [
        "사연에 정성스레 담긴 네 마음의 글자들을 하나하나 깊이 눈 and 마음에 담으며 오랫동안 깊은 생각에 잠겼단다. 다른 사람들에게는 차마 털어놓지 못하고 속으로 꾹꾹 삼켜야만 했던 수많은 서운함과 상처의 말들이 네 가슴속에 켜켜이 쌓여 얼마나 큰 답답함과 깊은 슬픔으로 자리 잡았을지 헤아려 보니 내 마음마저 참 아프고 시려오는구나. 너는 늘 책임감 있게 행동하고 다른 사람들을 먼저 배려하느라, 정작 네가 아프고 무너지는 그 결정적인 순간에는 아무에게도 기대지 못한 채 혼자 숨어 외롭게 흐느껴야 했겠지. '나만 참으면 모두가 편해진다'는 생각으로 하루하루를 버텨온 날들이 길어질수록, 네 안의 어린아이는 외롭고 두려워 조용히 울부짖고 있었을 거야. 그동안 그 거대하고 무거운 감정의 파도를 홀로 맞서며 온몸으로 견뎌온 시간들에 대해, 무엇보다 먼저 너에게 참 고생했다고, 정말 외로웠겠다고, 그리고 참 장하게 잘 버텨왔다고 따뜻한 위로의 인사를 건네고 싶단다.",
        "네가 지금 느끼고 있는 깊은 우울함과 무기력, 그리고 불쑥 찾아오는 �const getDefaultRecoveryDays = (isKo: boolean) => isKo ? [
  {
    day: 1,
    letter: "오늘부터 7일간의 아름다운 여정을 함께하게 되어 정말 기쁩니다. 첫날인 오늘은 무언가를 억지로 바꾸려 하지 않고, 그저 지금 내 마음에 가만히 이름을 붙여주는 연습을 해볼 거예요. 우리는 보통 슬프거나 지치거나 화가 날 때, 마음 한구석에 숨겨둔 감정들을 그냥 '힘들다'는 투박한 한마디로 덮어버리곤 합니다. 그렇게 갈 길을 잃은 감정들은 마음 아주 깊은 곳에 쌓여서, 나중에 당신을 더 무겁게 짓누르고 아프게 만들곤 하지요. 오늘은 잠시 가만히 멈춰 서서 지금 당신이 느끼는 구체적인 감정의 결을 소리 내어 다정하게 불러보시기 바랍니다. '나는 오늘 하루 종일 괜찮은 척 웃느라 참 많이 피곤했다'라든가, '마음 한쪽이 텅 빈 것처럼 쓸쓸하고 외롭다'처럼 말이지요. 감정에 정확하고 구체적인 이름을 붙여주는 것만으로도, 그 감정은 스스로를 치유하고 흘러갈 준비를 마치게 됩니다. 뇌과학에서도 감정에 이름을 붙이는 명명(Labeling) 작용을 통해 뇌의 감정 중추인 편도체의 과도한 불안과 흥분이 차분히 가라앉는다고 하지요. 오늘 밤 침대에 눕기 전, 굳어있던 당신의 마음에 가장 알맞은 따뜻하고 예쁜 이름을 선물해 주시기 바랍니다.",
    sentence: "오늘 마음에 붙여준 이름: '괜찮은 척하느라 참 지쳤던 마음'",
    action: "자기 전에 가슴에 가만히 손을 얹고, 오늘 내 감정을 한 문장으로 나직하게 소리 내어 말해보기"
  },
  {
    day: 2,
    letter: "어제 마음에 이름을 붙여주는 첫 연습은 어떠셨나요? 조금은 어색하고 낯설었을지라도, 오롯이 스스로를 돌아보고 알아차려 준 그 시간 자체가 정말로 귀중한 시작이랍니다. 둘째 날인 오늘은 어제에 이어 '괜찮은 척했던 마음의 가면을 가만히 내려놓기'를 연습해 볼 거예요. 우리는 학교나 직장, 혹은 친구들을 만날 때 늘 아무렇지 않은 척, 늘 밝고 건강한 척 가면을 쓰곤 합니다. 하지만 그렇게 온종일 쓰고 있던 두껍고 무거운 가면을 집으로 돌아온 밤까지 벗지 못한다면, 당신의 마음은 결국 짓눌려 숨이 막히고 말 테지요. 오늘은 단 10분만이라도 그 무거운 가면을 내려놓고 마음의 여리고 약한 취약함을 솔직하게 대면해 보시기 바랍니다. 꼭 누군가에게 보이기 위해서가 아니라, 당신 스스로에게 다정해지기 위해서이지요. 괜찮지 않아도 정말로 괜찮습니다. 울고 싶다면 마음껏 소리 내어 울어도 좋고, 답답하다면 이불을 쥐어짜며 감정을 가만히 밖으로 쏟아내 보세요. 감정을 가둘수록 상처는 안으로 곪아가지만, 밖으로 비워낼 때 비로소 회복이 시작됩니다. 오늘 당신의 하루 중 가장 숨이 막혔던 장면을 메모지에 한 줄 적어보며 가면을 벗는 홀가분함을 느껴보세요.",
    sentence: "괜찮지 않아도 괜찮습니다. 오늘의 나는 조금 아프고 약해져도 괜찮은 사람이니까요.",
    action: "하루 중 가장 괜찮은 척 애써야 했던 장면을 작은 종이에 한 줄로 솔직하게 적고 가만히 찢어버리기"
  },
  {
    day: 3,
    letter: "벌써 셋째 날이 되었네요. 어제 가면을 조금이나마 내려놓고 지내보니 기분이 어떠셨을지 가만히 생각해 봅니다. 오늘은 마음속에 가장 날카롭고 깊이 박혀 나를 찌르고 있는 가시인 '자책을 덜어내는 날'이에요. 삶에서 힘든 일이 생기거나 누군가와의 관계가 뜻대로 흘러가지 않을 때, 우리는 무의식적으로 스스로에게 칼날을 겨누곤 합니다. 하지만 자책은 결코 상황을 해결해주지 못할 뿐만 아니라, 당신의 소중한 가치를 갉아먹는 가장 아픈 독이 될 뿐이지요. 당신이 겪고 있는 모든 흔들림과 아픔은 결코 당신이 부족하거나 약해서가 아닙니다. 그 어떤 누구라도 그 힘겨운 상황 속에서는 당신처럼 힘들어했을 것이고, 당신은 그 와중에도 최선의 노력과 선택을 다해 여기까지 오셨을 테지요. 그러니 오늘만큼은 스스로를 찌르던 날카로운 화살을 내려놓아 주시기 바랍니다. 자신을 탓하던 차가운 말들 대신에 '그때는 그럴 수밖에 없었어', '그동안 참 고생하셨습니다'라며 오롯이 당신 편이 되어 따뜻한 위로와 지지를 들려주세요.",
    sentence: "그것은 당신의 잘못이 아닙니다. 당신은 그 아픔 속에서도 매 순간 최선을 다했으니까요.",
    action: "거울 속의 내 눈을 가만히 바라보며 '당신은 잘못이 없어요, 참 잘해왔어요'라고 따뜻하게 속삭여주기"
  },
  {
    day: 4,
    letter: "넷째 날이 왔습니다. 어느덧 마음을 온전히 보듬는 여정의 절반을 힘차게 지나왔네요. 오늘은 하루 종일 생각에만 갇혀 있던 감정의 무거운 굴레에서 잠시 벗어나, '몸을 움직이며 나를 미워하지 않는 감각 깨우기'를 함께해봅니다. 마음이 복잡하고 무거울 때 방안에 가만히 누워 생각의 꼬리를 물다 보면, 우리의 뇌는 자꾸만 더 우울하고 부정적인 시나리오를 끊임없이 만들어내며 당신을 어둠 속으로 더욱 끌고 들어가지요. 그 생각의 꼬리를 즉시 끊어내는 가장 강력하고 확실한 방법은 바로 몸의 감각을 부드럽고 다정하게 깨우는 일입니다. 대단한 운동을 하거나 밖으로 거창하게 나가지 않아도 좋지요. 그저 5분 동안 방 안의 창문을 활짝 열고 맑은 공기를 쐬거나, 차가운 물로 세수를 하며 피부에 닿는 촉감에 온전히 집중해 보시기 바랍니다. 몸이 가만히 움직이기 시작하면 정체되어 있던 마음의 흐린 안개도 한결 맑게 개어 가기 시작할 테지요. 무기력함이 당신을 지배하려 할 때, 가벼운 몸의 움직임 하나로 몸과 마음의 신선한 순환을 선물하고 새로운 치유 에너지를 가득 채워주시기 바랍니다.",
    sentence: "생각이 너무 무거워질 때는 잠시 멈추고, 지금 내 손끝과 발끝의 감각을 가만히 느껴보세요.",
    action: "창문을 활짝 열고 시원한 공기를 세 번 깊게 들이쉬며, 내 몸의 호흡이 나가는 것을 가만히 관찰하기"
  },
  {
    day: 5,
    letter: "다섯째 날이 밝았습니다. 오늘의 당신은 그동안 차마 소리 내어 입 밖으로 내지 못하고 마음의 깊은 바닷속에 가만히 가라앉혀 두었던 '오래 삼킨 마음의 말 한 문장을 안전하게 꺼내보는 소중한 날'이에요. 누군가에게 상처를 주거나 관계가 깨질까 봐 두려워서 억지로 삼켜버린 말들은 마음속에서 결코 사라지지 않고 깊이 고여 계속 아프게 만듭니다. 그 응어리진 말들은 밖으로 꺼내어 마주하기 전까지는 계속해서 내면에서 소리 없는 비명을 지르지요. 오늘은 그 누구의 시선도, 차가운 눈치도 전혀 보지 않고 오직 당신만 볼 수 있는 일기장에 그동안 참았던 속마음을 솔직하게 적어 보시기 바랍니다. '그때 저는 정말 서운하고 화가 많이 났었어요', '사실 제가 요즘 너무 아프고 기댈 곳이 필요해요' 처럼 솔직한 외침이어도 다 괜찮지요. 그렇게 글로 적어 눈으로 직접 확인하는 순간, 내면에 갇혀 가슴을 조이던 억압된 슬픔과 분노가 비로소 자유를 얻게 됩니다. 표현되지 못한 아픔은 절대 스스로 사라지지 않는 법이지요. 가장 안전한 당신의 공간에서 목소리를 가만히 꺼내어 해방해 주시기 바랍니다.",
    sentence: "삼켜왔던 아픈 말들을 이제는 내 가슴 밖으로 가만히 내어주어도 괜찮습니다.",
    action: "누구에게도 하지 못했던 속마음 한 문장을 노트에 꾹꾹 눌러 적은 뒤, 다 적고 나서 후련하게 크게 한숨 쉬기"
  },
  {
    day: 6,
    letter: "여섯째 날이군요. 여정의 끝자락이 드디어 가까워지고 있습니다. 오늘은 고립되어 있던 당신만의 동굴을 나와 세상과 가볍게 닿아보세요. 마음이 아프고 지칠 때 우리는 본능적으로 방 안으로 깊이 숨어버리게 되고, 그 외로운 단절 속에서 아픔은 걷잡을 수 없이 증폭되곤 합니다. 하지만 우리는 타인과의 사소한 연결을 통해서도 엄청난 안도감과 지지를 얻을 수 있는 존재이지요. 결코 많은 에너지를 써서 사람들을 만나러 나가지 않아도 괜찮습니다. 평소 고마웠던 사람에게 가벼운 인사를 건네거나 온라인에 오늘 하늘 사진을 공유하는 것만으로도 충분하지요. 타인과 가볍게 주고받는 안부의 한마디는 당신의 어두운 마음에 따뜻한 등불 하나를 켜줄 것입니다. 스스로 혼자 외롭고 힘든 것이 아니라는 깊은 위안과 안도감이 오늘 당신의 발걸음을 가볍게 만들어 주겠지요.",
    sentence: "당신은 결코 혼자가 아닙니다. 보이지 않아도 따뜻한 연결이 주변을 감싸고 있으니까요.",
    action: "가까운 지인이나 소중한 사람에게 '문득 생각나서 연락했어, 좋은 하루 보내'라고 부담 없는 안부 문자 보내기"
  },
  {
    day: 7,
    letter: "드디어 7일간의 길고 아름다운 마음 회복 여정을 마무리하는 마지막 날이군요. 일주일이라는 시간 동안 하루도 빠짐없이 매일 내면을 따뜻하게 들여다보고 스스로에게 다정한 안부를 묻는 일은 결코 쉬운 일이 아니었을 텐데, 중도에 포기하지 않고 여기까지 묵묵히 걸어온 당신 자신이 정말로 대견하고 자랑스럽습니다. 그동안 상처받고 아파했던 마음을 스스로 보듬고 돌보느라 참 성실하게 잘 애써왔어요. 오늘은 오직 자신만을 위해 온기와 깊은 사랑이 가득 담긴 위로의 답장을 가만히 선물해주는 날이랍니다. 거울 속의 모습을 가만히 들여다보며 눈을 맞추거나, 혹은 지친 마음에 나직하게 속삭이듯 '그동안 외롭고 고단했던 밤들을 홀로 견디며 포기하지 않고 살아내 줘서 정말 고맙습니다'라고 가슴 깊이 감사를 전해보세요. 이 7일간의 소중한 발자국들이 마음속에 단단하고 든든한 씨앗이 되어, 당신의 앞날에 다정함과 행복의 꽃을 환하게 피워낼 것입니다. 언제나 당신을 향해 있을 제 진심 어린 응원과 온기를 잊지 말고, 늘 평안하고 따뜻하게 살아가길 간절히 바랄게요. 정말 고생 많으셨고 참 애쓰셨습니다.",
    sentence: "7일 동안 멈추지 않고 스스로를 돌봐준 당신에게, 온 마음을 다해 고맙다는 인사를 건넵니다.",
    action: "이 여정을 끝마친 나를 위해 따뜻하고 포근한 차 한 잔을 선물하며, 가만히 눈을 감고 수고한 내 어깨를 토닥여주기",
    summary_sentences: [
      "아픔은 머무는 것이 아니라, 잠시 스쳐 지나가는 소나기일 뿐입니다.",
      "흔들릴 때는 마음껏 흔들려도 괜찮으니, 결국 제자리로 돌아오면 되지요.",
      "어떤 순간에도 스스로가 당신의 편이 되어주는 일을 멈추지 말아주시기 바랍니다."
    ]
  }
] : [
  {
...
];recious ${giftRecipient || "one"}. Measuring your silent struggle and exhaustion you might be experiencing lately from afar, I hope it becomes a small shade where your tired heart can rest for a while. Even if moments of trembling and wanting to collapse come, please do not forget that a precious existence silently cheering and supporting you from behind is always by your side.`,
...
const getDefaultRecoveryDays = (isKo: boolean) => isKo ? [
    ...
    {
    day: 1,
    letter: "오늘부터 7일간의 아름다운 여정을 함께하게 되어 정말 기뻐요. 첫날인 오늘은 무언가를 억지로 바꾸려 하지 않고, 그저 지금 내 마음에 가만히 이름을 붙여주는 연습을 해볼 거예요. 우리는 보통 슬프거나 지치거나 화가 날 때, 마음 한구석에 숨겨둔 감정들을 그냥 '힘들다'는 투박한 한마디로 뭉뚱그려 덮어버리곤 하지요. 그렇게 갈 길을 잃어버린 감정들은 마음 아주 깊은 곳에 켜켜이 쌓여서, 나중에 당신을 더 무겁게 짓누르고 아프게 만들곤 합니다. 오늘은 잠시 가만히 멈춰 서서 지금 당신이 느끼는 구체적인 감정의 결을 소리 내어 다정하게 불러보세요. '나는 오늘 하루 종일 괜찮은 척 웃느라 참 많이 피곤했다'라든가, '마음 한쪽이 텅 빈 것처럼 쓸쓸하고 외롭다'처럼 말이지요. 감정에 정확하고 구체적인 이름을 붙여주는 것만으로도, 그 감정은 스스로를 치유하고 흘러갈 준비를 하게 됩니다. 뇌과학에서도 감정에 이름을 붙이는 명명(Labeling) 작용을 통해 뇌의 감정 중추인 편도체의 과도한 불안과 흥분이 차분히 가라앉는다고 하지요. 오늘 밤 침대에 눕기 전, 굳어있던 당신의 마음에 가장 알맞은 따뜻하고 예쁜 이름을 선물해 주세요.",
    sentence: "오늘 마음에 붙여준 이름: '괜찮은 척하느라 참 지쳤던 마음'",
    action: "자기 전에 가슴에 가만히 손을 얹고, 오늘 내 감정을 한 문장으로 나직하게 소리 내어 말해보기"
  },
  {
    day: 2,
    letter: "어제 마음에 이름을 붙여주는 첫 연습은 어떠셨나요? 조금은 어색하고 낯설었을지라도, 오롯이 스스로를 돌아보고 알아차려 준 그 시간 자체가 정말로 귀중한 시작이랍니다. 둘째 날인 오늘은 어제에 이어 '괜찮은 척했던 마음의 가면을 가만히 내려놓기'를 연습해 볼 거예요. 우리는 학교나 직장, 혹은 친구들을 만날 때 늘 아무렇지 않은 척, 늘 밝고 건강한 척 가면을 쓰곤 하지요. 하지만 그렇게 온종일 쓰고 있던 두껍고 무거운 가면을 집으로 돌아온 밤까지 벗지 못한다면, 당신의 마음은 결국 짓눌려 숨이 막하고 말 것입니다. 오늘은 단 10분만이라도 그 무거운 가면을 내려놓고 마음의 여리고 약한 취약함을 솔직하게 대면해 보세요. 꼭 누군가에게 보이기 위해서가 아니라, 당신 스스로에게 다정해지기 위해서랍니다. 괜찮지 않아도 정말로 괜찮아요. 울고 싶다면 마음껏 소리 내어 울어도 좋고, 답답하다면 이불을 쥐어짜며 감정을 가만히 밖으로 쏟아내 보세요. 감정을 가둘수록 상처는 안으로 곪아가지만, 밖으로 비워낼 때 비로소 회복이 시작됩니다. 오늘 당신의 하루 중 가장 숨이 막혔던 장면을 메모지에 한 줄 적어보며 가면을 벗는 홀가분함을 느껴보세요.",
    sentence: "괜찮지 않아도 괜찮습니다. 오늘의 나는 조금 아프고 약해져도 괜찮은 사람이니까요.",
    action: "하루 중 가장 괜찮은 척 애써야 했던 장면을 작은 종이에 한 줄로 솔직하게 적고 가만히 찢어버리기"
  },
  {
    day: 3,
    letter: "벌써 셋째 날이 되었네요. 어제 가면을 조금이나마 내려놓고 지내보니 기분이 어떠셨을지 가만히 생각해 봅니다. 오늘은 마음속에 가장 날카롭고 깊이 박혀 나를 찌르고 있는 가시인 '자책을 덜어내는 날'이에요. 삶에서 힘든 일이 생기거나 누군가와의 관계가 뜻대로 흘러가지 않을 때, 우리는 무의식적으로 '내가 그때 더 잘했어야 했는데', '전부 내 탓이야'라며 스스로에게 칼날을 겨누곤 하지요. 하지만 자책은 결코 상황을 해결해주지 못할 뿐만 아니라, 당신의 소중한 가치를 갉아먹는 가장 아픈 독이 될 뿐이랍니다. 당신이 겪고 있는 모든 흔들림과 아픔은 결코 당신이 부족하거나 약해서가 아니에요. 그 어떤 누구라도 그 힘겨운 상황 속에서는 당신처럼 힘들어했을 것이고, 당신은 그 와중에도 당신이 할 수 있는 최선의 노력과 선택을 다해 여기까지 온 것이랍니다. 그러니 오늘만큼은 스스로를 찌르던 날카로운 화살을 내려놓아 주세요. 자신을 탓하던 차가운 말들 대신에 '그때는 그럴 수밖에 없었어', '그동안 참 애썼다'라며 오롯이 내 편이 되어 따뜻한 위로와 지지를 들려주길 바랄게요.",
    sentence: "그것은 당신의 잘못이 아닙니다. 당신은 그 아픔 속에서도 매 순간 최선을 다했으니까요.",
    action: "거울 속의 내 눈을 가만히 바라보며 '당신은 잘못이 없어요, 참 잘해왔어요'라고 따뜻하게 속삭여주기"
  },
  {
    day: 4,
    letter: "넷째 날이 왔습니다. 어느덧 마음을 온전히 보듬는 여정의 절반을 힘차게 지나왔네요. 오늘은 하루 종일 생각에만 갇혀 있던 감정의 무거운 굴레에서 잠시 벗어나, '몸을 가볍게 움직이며 나를 미워하지 않는 새로운 감각을 깨우는 연습'을 함께해볼 거예요. 마음이 복잡하고 무거울 때 방안에 가만히 누워 생각의 꼬리를 물다 보면, 우리의 뇌는 자꾸만 더 우울하고 부정적인 시나리오를 끊임없이 만들어내며 당신을 어둠 속으로 더욱 끌고 들어가지요. 그 생각의 꼬리를 즉시 끊어내는 가장 강력하고 확실한 방법은 바로 몸의 감각을 부드럽고 다정하게 깨우는 일이랍니다. 대단한 운동을 하거나 밖으로 거창하게 나가지 않아도 좋아요. 그저 5분 동안 방 안의 창문을 활짝 열고 맑은 공기를 쐬거나, 차가운 물로 세수를 하며 피부에 닿는 시원하고 생생한 촉감에 온전히 집중해 보는 것이지요. 몸이 가만히 움직이기 시작하면 정체되어 있던 마음의 흐린 안개도 한결 맑게 개어 가기 시작합니다. 무기력함이 당신을 지배하려 할 때, 가벼운 몸의 움직임 하나로 몸과 마음의 신선한 순환을 선물하고 새로운 치유 에너지를 가득 채워주세요.",
    sentence: "생각이 너무 무거워질 때는 잠시 멈추고, 지금 내 손끝과 발끝의 감각을 가만히 느껴보세요.",
    action: "창문을 활짝 열고 시원한 공기를 세 번 깊게 들이쉬며, 내 몸의 호흡이 나가는 것을 가만히 관찰하기"
  },
  {
    day: 5,
    letter: "다섯째 날이 밝았습니다. 오늘의 당신은 그동안 차마 소리 내어 입 밖으로 내지 못하고 마음의 깊은 바닷속에 가만히 가라앉혀 두었던 '오래 삼킨 마음의 말 한 문장을 안전하게 꺼내보는 소중한 날'이에요. 누군가에게 상처를 주거나 관계가 깨질까 봐 두려워서 억지로 삼켜버린 말들은 마음속에서 결코 사라지지 않고 깊이 고여 계속 아프게 만듭니다. 그 응어리진 말들은 밖으로 꺼내어 마주하기 전까지는 계속해서 내면에서 소리 없는 비명을 지르지요. 오늘은 그 누구의 시선도, 차가운 눈치도 전혀 보지 않고 오직 당신만 볼 수 있는 일기장이나 비밀 메모장에 그동안 참았던 속마음을 아주 솔직하게 적어 내려가 보세요. '그때 난 정말 서운하고 화가 많이 났었어', '사실 나 요즘 너무 아프고 기댈 곳이 필요해' 처럼 날것 그대로의 외침이어도 괜찮습니다. 그렇게 글로 적어 눈으로 직접 확인하는 순간, 내면에 갇혀 가슴을 조이던 억압된 슬픔과 분노가 비로소 자유를 얻게 되지요. 표현되지 못한 아픔은 절대 스스로 사라지지 않아요. 가장 안전한 당신의 공간에서 목소리를 가만히 꺼내어 해방해 주세요.",
    sentence: "삼켜왔던 아픈 말들을 이제는 내 가슴 밖으로 가만히 내어주어도 괜찮습니다.",
    action: "누구에게도 하지 못했던 속마음 한 문장을 노트에 꾹꾹 눌러 적은 뒤, 다 적고 나서 후련하게 크게 한숨 쉬기"
  },
  {
    day: 6,
    letter: "여섯째 날이군요. 여정의 끝자락이 드디어 가까워지고 있네요. 오늘은 고립되어 있던 당신만의 동굴을 나와 '세상과 가볍게 닿아보는 날'로 보내보세요. 마음이 아프고 지칠 때 우리는 본능적으로 내 방 안으로 깊이 숨어버리게 되고, 그 외로운 단절 속에서 아픔은 걷잡을 수 없이 증폭되곤 하지요. 하지만 우리는 타인과의 작고 사소한 연결을 통해서도 엄청난 안도감과 지지를 얻을 수 있는 존재랍니다. 결코 많은 에너지를 써서 사람들을 만나러 나가지 않아도 좋아요. 평소 고마웠던 사람에게 '오늘 날씨가 참 좋다, 잘 지내고 있니?' 하고 짧은 안부 문자를 한 통 보내거나, 편의점 직원이나 이웃에게 가벼운 눈인사를 건네거나, 온라인에 오늘 하늘 사진을 공유하는 것만으로 충분합니다. 타인과 가볍게 주고받는 안부의 한마디는 당신의 어두운 마음에 따뜻하고 은은한 등불 하나를 켜줄 거예요. 나만 혼자 외롭고 힘든 것이 아니라는 깊은 위안과, 여전히 내가 이 따뜻한 세상과 연결되어 있다는 안도감이 오늘 당신의 발걸음을 한결 가볍게 만들어 주길 바랄게요.",
    sentence: "당신은 결코 혼자가 아닙니다. 보이지 않아도 따뜻한 연결이 주변을 감싸고 있으니까요.",
    action: "가까운 지인이나 소중한 사람에게 '문득 생각나서 연락했어, 좋은 하루 보내'라고 부담 없는 안부 문자 보내기"
  },
  {
    ...
    summary_sentences: [
      ...
      "어떤 순간에도 스스로가 내 편이 되어주는 일을 멈추지 말아주세요."
    ]
  }
] : [
  {
